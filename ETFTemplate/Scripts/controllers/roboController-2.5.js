...
myRobo = function (app, containerquestion) {

    this.code = '';
    this.App = app;
    this.settings = app.Settings;
    this.kycid = app.Settings.questionnaire;
    this.session = null;
    this.fees = 0;
...
myRobo.prototype.allocation = function (valuedate, callback) {
    ...
    me.getAnswers(function (answers) {
        myReadAnswers(me, valuedate, answers, callback);
    })  
};
...
myAllocation = function (code, valuedate) {
    ...
    this.ManagementFeesRate = 0;
    this.ManagementFeesPeriod = 0;
    this.Records = [];
};
